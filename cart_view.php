...
<body>
    <div id="page">
        ...
        <p class="right" ><a  href=".?action=clear_cookies">End Session and Delete Cookies</a></p>
        <p class="right">Session ID:  <?php echo session_id()?> </p>
    </div><!-- end page -->
</body>
</html>
